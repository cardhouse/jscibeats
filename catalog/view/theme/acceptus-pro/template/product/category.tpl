...
<div id="content"><?php echo $content_top; ?>
  ...
  <?php } else { ?>
  <!-- Removing the 'no image' image because it looks like shit.
  ...
  <div class="product-filter clearafter">
    <!-- Removing the option to show in grid form until I figure out how to display the soundcloud player
  ...
  <div class="box-product product-list list-layout">
	...
	?>
    <div>
      <!-- Removing the thumbnail image in the corner of the category display to fix spacing
