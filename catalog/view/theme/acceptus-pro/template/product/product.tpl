...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="right" style="width: <?php echo $this->config->get('config_image_thumb_width') + 20 ?>px;">
      ...
      <div class="image clearafter">
        <a href="<?php echo $popup; ?>" class="jqzoom colorbox" rel='gal1' title="<?php echo $heading_title; ?>" >
            <img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" width="<?php echo $this->config->get('config_image_thumb_width'); ?>" height="<?php echo $this->config->get('config_image_thumb_height'); ?>" />
        </a>
      </div>
      <?php } else { ?>
      ...
      <ul class="thumblist clearafter">
        <li>
        <a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: '<?php echo $thumb; ?>',largeimage: '<?php echo $popup; ?>'}">
            <img src="<?php echo $thumb; ?>" width="<?php echo $this->config->get('config_image_additional_width'); ?>" height="<?php echo $this->config->get('config_image_additional_height'); ?>" />
        </a>
        </li>
        <?php if ($images) { ?>
        <?php foreach ($images as $image) { ?>
		<li>
		<a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: '<?php echo $image['popup']; ?>',largeimage: '<?php echo $image['popup']; ?>'}">
    ...
    <div class="left" style="margin-right: <?php echo $this->config->get('config_image_thumb_width') + 75 ?>px;">
      ...
      <div class="review">
        <img src="catalog/view/theme/acceptus-pro/image/icons/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><a class="show-review" href="#tabs"><?php echo $reviews; ?></a>
  ...
  <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
    ...
    <select name="option[<?php echo $option['product_option_id']; ?>]">
      ...
      <option value="<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?>
      	<?php $diff = preg_replace("/[^.0-9 ]/", '', $option_value['price']); ?>
      	<?php $int_price = preg_replace("/[^.0-9 ]/", '', $price); ?>
      	<?php echo '$'. ((int)$diff+$int_price); ?>
      </option>
      <?php } ?>
    </select>
  </div>
