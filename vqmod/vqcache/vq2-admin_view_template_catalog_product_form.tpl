...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-profile"><?php echo $tab_profile; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><?php if($do_edit) {?><a href="#tab-scheme"><?php echo $tab_scheme; ?></a><?php }?></div>
...
<td class="left"><?php echo $entry_download_option; ?></td>
                  <td></td>
                </tr>
              </thead>
...
<td class="left">
               <select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][download_id]">
               <option value=""></option>
               <?php foreach ($downloads as $download) { ?>
               <?php if ($download['download_id'] == $product_option_value['download_id']) { ?>
...
html += '        <td class="left"><?php echo $entry_download_option; ?></td>';
			html += '        <td></td>';
			html += '      </tr>';
			html += '  	 </thead>';
			html += '    <tfoot>';
...
function addOptionValue(option_row) {	
	...
	html += '    <input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][weight]" value="" size="5" /></td>';
                    ...
                    html += ' <td class="left"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][download_id]">';
                    html += ' <option value=""></option>';
                    <?php foreach ($downloads as $download) { ?>
