...
<div id="TabModule_{{= moduleRow}}" class="vtabs-content clearafter">
    ...
    <div id="Setting_{{= moduleRow}}_<?php echo $language['language_id']; ?>">
        <table class="form">
            ...
            <tr>
                <td><?php echo __('Module Style'); ?>:</td>
                <td>
            ...
            <tr id="WidthRow_{{= moduleRow}}_<?php echo $language['language_id']; ?>">
                <td><span class="required">*</span> <?php echo __('Width'); ?></td>
                <td>
                    <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][width]" value="{{= module.data[<?php echo $language['language_id']; ?>].width}}" placeholder="width" size="5" required="required" />
            ...
            <tr>
                ...
                <td>
                    <span class="RelatedFluid_{{= moduleRow }}_<?php echo $language['language_id']; ?>">Height: </span><input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][height]" value="{{= module.data[<?php echo $language['language_id']; ?>].height}}" placeholder="height" size="5" required="required" />
                    <p class="RelatedFluid_{{= moduleRow }}_<?php echo $language['language_id']; ?>">
                        Screen Width: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][screen][0]" value="{{= module.data[<?php echo $language['language_id']; ?>].screen[0]}}" placeholder="1024" size="5" required="required" />
                        Slider Height: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][other_height][0]" value="{{= module.data[<?php echo $language['language_id']; ?>].other_height[0]}}" placeholder="height" size="5" required="required" />
                    </p>
                    <p class="RelatedFluid_{{= moduleRow }}_<?php echo $language['language_id']; ?>">
                        Screen Width: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][screen][1]" value="{{= module.data[<?php echo $language['language_id']; ?>].screen[1]}}" placeholder="768" size="5" required="required" />
                        Slider Height: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][other_height][1]" value="{{= module.data[<?php echo $language['language_id']; ?>].other_height[1]}}" placeholder="height" size="5" required="required" />
                    </p>
                    <p class="RelatedFluid_{{= moduleRow }}_<?php echo $language['language_id']; ?>">
                        Screen Width: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][screen][2]" value="{{= module.data[<?php echo $language['language_id']; ?>].screen[2]}}" placeholder="480" size="5" required="required" />
                        Slider Height: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][other_height][2]" value="{{= module.data[<?php echo $language['language_id']; ?>].other_height[2]}}" placeholder="height" size="5" required="required" />
                    </p>
                    <p class="RelatedFluid_{{= moduleRow }}_<?php echo $language['language_id']; ?>">
                        Screen Width: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][screen][3]" value="{{= module.data[<?php echo $language['language_id']; ?>].screen[3]}}" placeholder="320" size="5" required="required" />
                        Slider Height: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][other_height][3]" value="{{= module.data[<?php echo $language['language_id']; ?>].other_height[3]}}" placeholder="height" size="5" required="required" />
                    </p>
                    <p class="RelatedFluid_{{= moduleRow }}_<?php echo $language['language_id']; ?>">
                        Screen Width: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][screen][4]" value="{{= module.data[<?php echo $language['language_id']; ?>].screen[4]}}" placeholder="" size="5" required="required" />
                        Slider Height: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][other_height][4]" value="{{= module.data[<?php echo $language['language_id']; ?>].other_height[4]}}" placeholder="height" size="5" required="required" />
                    </p>
                    <p class="RelatedFluid_{{= moduleRow }}_<?php echo $language['language_id']; ?>">
                        Screen Width: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][screen][5]" value="{{= module.data[<?php echo $language['language_id']; ?>].screen[5]}}" placeholder="" size="5" required="required" />
                        Slider Height: <input type="text" name="modules[{{= moduleRow}}][data][<?php echo $language['language_id']; ?>][other_height][5]" value="{{= module.data[<?php echo $language['language_id']; ?>].other_height[5]}}" placeholder="height" size="5" required="required" />
                    </p>
            ...
            <tr class="RowSettingDuration_{{= moduleRow }}">
...
<script type="text/javascript">
    ...
    var Setting = (function () {
        ...
        function toggleRelatedRow(option) {
            var $relatedRow = $($(option).data('relatedRow'));
        ...
        return {
            init: function () {
                ...
                // Dimesion Type
                $('#ModuleContainer').on('change', '.DimensionType', function () {
